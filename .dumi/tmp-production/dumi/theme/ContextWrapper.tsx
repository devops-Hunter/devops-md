...
import { SiteContext } from '/root/devops-md/node_modules/.store/dumi@2.1.17/node_modules/dumi/dist/client/theme-api/context.js';
...
export default function DumiContextWrapper() {
  ...
  return (
    <SiteContext.Provider value={{
      pkg: {"name":"devops","description":"云原生技术分享","version":"0.0.1","license":"MIT","authors":["hunter.shen@outlook.com"]},
      entryExports,
      demos,
      components,
      locales,
